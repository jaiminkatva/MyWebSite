...
<head>
  <meta charset="utf-8" />
  <title>R K Engineering & Solutions</title>
...
<body>
      ...
      <div class="row gx-0 align-items-center">
        <div class="col-lg-8 text-center text-lg-start mb-lg-0">
          <div class="d-flex flex-wrap">
            ...
            <div class="ps-3">
              <a href="mailto:example@gmail.com" class="text-muted small"><i class="fas fa-envelope text-primary me-2"></i>rkengsolutions@gmail.com
              </a>
            </div>
          </div>
        </div>
      ...
      <nav class="navbar navbar-expand-lg navbar-light">
        <a href="#" class="navbar-brand p-0">
          <h1 class="text-primary mb-0">
            <img src="./rkdoc/RK-Logo-Web.png" alt="" width="200px" />
        ...
        <div class="d-none d-xl-flex flex-shrink-0 ps-4">
          <img src="/rkdoc/Earthbeat.png" alt="" width="160px" />
          <a
            href="#"
      ...
      <div class="row g-5">
        <div class="col-xl-6 wow fadeInLeft" data-wow-delay="0.2s">
          <div class="about-item-content bg-white rounded p-5 h-100">
            ...
            <a class="btn btn-primary rounded-pill py-3 px-5" href="#">Are Your Intrusted ?</a>
          </div>
        </div>
  ...
  <div class="container-fluid service py-3">
    <div class="container py-5">
      ...
      <div class="row g-5">
        <div
          class="col-lg-6 col-md-12 mb-4 wow fadeInLeft"
          data-wow-delay="0.2s">
          <div class="table-responsive shadow" style="border-radius: 10px">
            <table class="table table-specs">
              ...
              <tbody>
                ...
                <tr>
                  <td>Product Type</td>
                  <td>Earthing Rod, Pure Copper Rod, Copper Bonded Rod</td>
                </tr>
                <tr>
                  <td>Material</td>
                  <td>Copper Bonded Steel</td>
                </tr>
                <tr>
                  <td>Application</td>
                  <td>Earthing</td>
                ...
                <tr>
                  <td>Diameter of Rod (mm)</td>
                  <td>15 mm, 17.2 mm, 20 mm, 25 mm, 32 mm</td>
                </tr>
              </tbody>
            </table>
          </div>
        ...
        <div
          class="col-lg-6 col-md-12 mb-4 wow fadeInRight"
          data-wow-delay="0.2s">
          <div class="table-responsive shadow" style="border-radius: 10px">
            <table class="table table-specs">
              <thead>
  ...
  <div class="container-fluid bg-light blog py-5">
    <div class="container py-5 bg-white">
      <div
        ...
        data-wow-delay="0.2s"
        style="max-width: 800px">
        <h1 class="text-primary">Industries</h1>
      </div>
      <div class="row g-4 justify-content-center">
          ...
          <div class="blog-item">
            <div class="blog-img">
              <img
                ...
                alt="" />
              <div class="blog-categiry py-2 px-4">
                <span>Electrical Equipment’s</span>
              </div>
            </div>
          </div>
        </div>
